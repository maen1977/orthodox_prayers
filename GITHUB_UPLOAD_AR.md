# رفع Orthodox Prayers 5.0.22 إلى GitHub

هذه النسخة مجهزة كمستودع مصدر نظيف، مع Workflow للبناء وWorkflow مستقل لنشر البيانات الموقعة.

## الرفع

1. فك ملف `OrthodoxPrayers-5.0.22-GitHub-Ready.zip` داخل مجلد جديد.
...
git init
git add .
git commit -m "Release Orthodox Prayers 5.0.22 with moving liturgical window"
git branch -M main
