...
public final class DailySnapshotRegressionGuardTest {
    @Test
    public void acceptsASecondWindowThatAddsMatinsGospel() {
    ...
    @Test
    public void rejectsASecondWindowThatDropsAcceptedReadingText() {
        JSONObject accepted = day(
                reading("epistle", "Romans", "Epistle text"),
                reading("gospel", "Matthew", "Gospel text")
        );
    ...
    @Test
    public void doesNotCompareDifferentDates() {
    ...
    private static JSONObject day(JSONObject... readings) {
    ...
    private static JSONObject reading(String kind, String reference, String body) {
        return new JSONObject()
                .put("kind", kind)
