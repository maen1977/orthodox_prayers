...
class ReleaseContractTests(unittest.TestCase):
    ...
    def test_version_and_release_hardening(self):
        ...
        self.assertIn('versionName = "5.0.20"', build)
        self.assertIn("versionCode = 50020", build)
    ...
    def test_daily_refresh_runs_at_one_and_six_amman_with_safe_fallback(self):
        ...
        self.assertIn("shouldCheckRemoteOnAppOpen", main)
        self.assertIn("AUTOMATIC_OPEN_RETRY_DELAY_MS", main)
    ...
    def test_workflows_cover_build_verified_data_security_and_signed_release(self):
        ...
        self.assertIn('cron: "7 0 * * *"', update)
        self.assertIn('cron: "37 0 * * *"', update)
        self.assertIn('cron: "37 6 * * *"', update)
