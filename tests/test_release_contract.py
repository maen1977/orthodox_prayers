...
class ReleaseContractTests(unittest.TestCase):
    ...
    def test_workflows_cover_build_verified_data_security_and_signed_release(self):
        ...
        self.assertIn("scripts/sign_daily_data.py", update)
        ...
        self.assertIn('data/calendar/today.json.sig', update)
        self.assertIn("scripts/validate_official_sources.py", update)
        self.assertIn("scripts/validate_no_placeholder_guidance.py", update)
        self.assertIn("scripts/validate_scripture_translations.py", update)
        self.assertIn("scripts/validate_native_language_packs.py", update)
        self.assertIn("scripts/validate_daily_native_content.py", update)
        self.assertIn("scripts/fill_daily_from_native_corpora.py", update)
        self.assertIn("--require-current --strict-native-lanes", update)
        self.assertIn("Verify published branch from origin", update)
        self.assertIn("Open or update failure alert", update)
