...
class ReleaseContractTests(unittest.TestCase):
    ...
    def test_version_and_release_hardening(self):
        ...
        self.assertIn('versionName = "5.0.12"', build)
        self.assertIn("versionCode = 50012", build)
    ...
    def test_next_sunday_schedule_sync_runs_after_native_fill(self):
        ...
        self.assertIn('PIPELINE_PATCH_LEVEL = "R16"', update)
    ...
    def test_single_application_repository_and_unique_work(self):
        ...
        self.assertIn("MIDNIGHT_FALLBACK_WORK", coordinator)
    ...
    def test_daily_refresh_runs_at_amman_midnight_with_safe_fallback(self):
        ...
        self.assertIn("scheduleMidnightRefresh", main)
        ...
        self.assertIn("plusDays(1).atStartOfDay(AMMAN_ZONE)", coordinator)
        self.assertIn("setExactAndAllowWhileIdle", coordinator)
        self.assertIn("canScheduleExactAlarms", coordinator)
        self.assertIn("MIDNIGHT_FALLBACK_WORK", coordinator)
        ...
        self.assertNotIn("CONFIRMATION_MINUTE", coordinator)
        self.assertNotRegex(coordinator, r"12,\s+TimeUnit\.HOURS")
        self.assertIn("enqueueMidnightRefresh", receiver)
        self.assertIn("scheduleMidnightRefresh", restore)
        self.assertIn("scheduleMidnightRefresh", worker)
        ...
        self.assertNotIn("00:15", settings)
        self.assertIn("00:00", settings)
