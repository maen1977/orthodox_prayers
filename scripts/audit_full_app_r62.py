...
def main():
    ...
    report={
      ...
      'metrics':{'calendar_days':len(days),'reading_counts':reading_counts,'generic_commemoration_days':generic_comm,'meaningful_occasion_days':meaningful_occ,'fast_days':fast_days,'church_groups':dict(church_groups),'church_total':churches.get('count'),'church_service_pending_full_text':cs_pending,'official_daily_prayer_links':official_prayer_links,'arabic_church_build_rights_pending':ar_rights_pending,'arabic_church_build_rights_confirmed':ar_rights_confirmed},
      'checks':checks,
