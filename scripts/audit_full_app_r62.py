...
def main():
    ...
    add('basil_liturgy','Saint Basil Liturgy','INCOMPLETE_FAIL_CLOSED','English is complete. The Arabic and Greek source lanes require clean re-import and review; their runtime packs contain only a non-liturgical blocked notice.', 'Import complete reviewed Arabic and Greek native editions before making this rite displayable.')
    add('presanctified_liturgy','Presanctified Liturgy','INCOMPLETE_FAIL_CLOSED','English and Greek are complete. The available Arabic material is explanatory rather than the full service; its runtime pack contains only a non-liturgical blocked notice.', 'Import a complete reviewed Arabic native edition before making this rite displayable.')
    ...
    report={
      'schema_version':1,'audit':'R62_FULL_APP_AUDIT','audited_on':'2026-08-13','base':'OrthodoxPrayers 5.6.4 R65 audit pass',
    ...
    lines=['# تدقيق R62 الكامل لتطبيق Orthodox Prayers','',f'تاريخ التدقيق: **2026-08-13**  ','النسخة الأساسية: **5.6.4 — مرور R65 التدقيقي**','',
