...
def main() -> None:
    ...
    print("SMART_LITURGY_OK version=5.6.3 strict_core=true chrysostom=ar,en,el basil=blocked presanctified=blocked wrong_rite_fallback=false machine_translation=false")
