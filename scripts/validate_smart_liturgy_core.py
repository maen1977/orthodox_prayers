...
def main() -> None:
    ...
    print("SMART_LITURGY_OK version=5.6.7 strict_core=true chrysostom=ar,en,el basil=ar,en,el presanctified=ar,en,el wrong_rite_fallback=false machine_translation=false ecclesiastical_certification=false")
