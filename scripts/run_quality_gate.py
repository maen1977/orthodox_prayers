...
def commands(require_current: bool, strict_native_lanes: bool) -> list[list[str]]:
    ...
    checks: list[list[str]] = [
        ...
        [sys.executable, "scripts/validate_liturgy_phase8_completion.py"],
        [sys.executable, "scripts/validate_liturgy_phase9_completion.py"],
        [sys.executable, "scripts/validate_liturgy_phase10_completion.py"],
        [sys.executable, "scripts/validate_liturgy_phase11_completion.py"],
        [sys.executable, "scripts/validate_liturgy_phase12_completion.py"],
