...
**حالة المستودع عند التوليد:** `02560a26720da1c83ae547dd9632cd1ebe55e276`
...
| الخدمات الكنسية المنفصلة | 10/10 كامل | 11/11 كامل | 11/11 كامل | الرابط فقط لا يُسمّى نصًا كاملاً |
...
| Ελληνικά | 11 | 0 | ست صفحات GLT native، أربع خدمات من صفحات UOI اليونانية المرخّصة، وخدمة التذكار من DCS اليوناني |

في العربية أصبحت الخدمات الكاملة offline هي: **church_baptism، church_confession، church_betrothal، church_marriage، church_crowns_removal، church_unction، church_funeral، church_memorial، church_trisagion، church_great_water**. وفي الإنجليزية أصبحت: **church_baptism، church_confession، church_betrothal، church_marriage، church_crowns_removal، church_unction، church_funeral، church_memorial، church_home_blessing، church_priesthood، church_great_water**. أما اليونانية فأصبحت فيها **11** خدمة كاملة offline من مصادر يونانية أصلية مسجلة: ست صفحات GLT، وأربع خدمات من صفحات محددة في PDF UOI المصوّر المرخّص، وخدمة التذكار من مقتطف يوناني مستقل محدود من DCS. الخدمات المضمّنة هي: **church_baptism، church_confession، church_betrothal، church_marriage، church_crowns_removal، church_unction، church_funeral، church_memorial، church_trisagion، church_priesthood، church_great_water**. ولا توجد حاليًا بطاقات رابط فقط في lane اليونانية. هذا قرار fail-closed مقصود؛ لم أستعمل نسخة Scribd أو نسخة تجارية غير متحقق من حقوقها، ولم أضع ترجمة بدل النص اليوناني.
...
المصدر الإنجليزي للخدمات الكنسية هو [Service Book of the Holy Orthodox-Catholic Apostolic Church (Hapgood) في Internet Archive][8]، وقد استُخدمت عناوينه المطبوعة لمراجعة حدود الاستخراج، لا لإثبات أن هذه الطبعة هي الصيغة الرعائية الوحيدة في القدس أو أنطاكية. المصادر اليونانية المضمّنة تشمل ست صفحات GLT اليونانية التابعة لنطاق GOARCH، وقد سُجلت في manifest مع تصريح المستخدم بإعادة التوزيع: [المعمودية][10] [الزواج والخطبة][11] [مسحة المرضى][12] [الجنازة][13] [التريصاجيون للراقدين][14]. كما أُضيفت أربعة اقتباسات يونانية محددة الصفحات من ملف Eucharologion المصوّر في University of Ioannina، المسجل CC-BY، مع provenance وOCR build-time وعدم ترجمة. وأُضيفت خدمة التذكار من قسم يوناني مستقل محدود داخل صفحة DCS بتاريخ 19 يوليو 2026، مع فصل النص اليوناني عن الإنجليزي وتسجيل تصريح المستخدم بإعادة التوزيع.
...
| الخدمات الكنسية اليونانية offline | مكتملة ضمن الكتالوج 11/11 | ست خدمات أُدرجت من صفحات GLT، وأربع من صفحات UOI اليونانية المرخّصة، وخدمة التذكار من مقتطف DCS يوناني مستقل محدود. |
...
لم أعدّل الواجهات أو منطق الاختيار أو التقويم. التغيير الدائم في هذه الجولة يشمل دعم parser لصفحات GLT القديمة، وإضافة أربع خدمات يونانية native من صفحات UOI محددة مع provenance وحقوق OCR build-time، وإضافة مقتطف يوناني مستقل لخدمة التذكار من DCS مع حدود وفصل لغوي موثق، وتحديث claims نطاق الاكتمال، مع بقاء مسارات العربية والإنجليزية دون استبدال.
